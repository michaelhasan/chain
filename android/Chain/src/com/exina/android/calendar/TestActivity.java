...
public class TestActivity extends PreferenceActivity implements Preference.OnPreferenceClickListener{
	...
	public void onCreate(Bundle savedInstance) {
		...
		addPreferencesFromResource(com.grandgranini.chain.R.xml.test);
	...
	public boolean onPreferenceClick(Preference  preference) {
		...
		if(key.equals("pick")) {
			...
			new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(com.grandgranini.chain.R.string.app_name).setMessage("http://code.google.com/p/android-calendar-view/\n\nBy Chris Gao<chris@exina.net>").create().show();
		}
		return true;
	}
}
